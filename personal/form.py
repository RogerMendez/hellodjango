...
class Contrato(forms.Form):
    #widget = attr0
    fecha_inicio = forms.DateField(label="Inicio Del Contrato",
        widget=SelectDateWidget(attrs={'id' :'fechas', 'styles':'{width:20;}'}))
    fecha_fin = forms.DateField(label="Fin Del Contrato",
        widget=SelectDateWidget(attrs={'id' :'fechas', 'styles':'{width:20;}'}))
